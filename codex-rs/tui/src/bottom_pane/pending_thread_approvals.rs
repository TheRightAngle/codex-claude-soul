    ...
    fn as_renderable(&self, width: u16) -> Box<dyn Renderable> {
        ...
        for thread in self.threads.iter().take(3) {
            let wrapped = adaptive_wrap_lines(
                std::iter::once(Line::from(format!("Codex needs your approval in {thread}"))),
...
mod tests {
    ...
    fn render_single_thread_snapshot() {
        ...
        assert_snapshot!(
            ...
            @"
        ..!.Codex.needs.your.approval.in.Robie..
        ....[explorer]..........................
    ...
    fn render_multiple_threads_snapshot() {
        ...
        assert_snapshot!(
            ...
            @"
        ..!.Codex.needs.your.approval.in.Main.......
        ....[default]...............................
        ..!.Codex.needs.your.approval.in.Robie......
        ....[explorer]..............................
        ..!.Codex.needs.your.approval.in.Inspector..
        ............................................
        ..../agent.to.switch.threads................
        "
        );
